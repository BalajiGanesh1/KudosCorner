    ...
    public class OfficeInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<OfficeContext>
    {
        protected override void Seed(OfficeContext context)
        {
          ...
          //  wishes.ForEach(s => context.Wishes.Add(s));
            ...
            {
            new Kudo{Image_Link="https://images.unsplash.com/photo-1504257365157-1496a50d48f2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80",Description="Alexander",Title="Alexander Rocks",Congrats_Messages=wishes},
            new Kudo{Image_Link="https://images.unsplash.com/photo-1504257365157-1496a50d48f2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80",Description="Alonso",Title="Alonso Rocks",Congrats_Messages=wishes},
            new Kudo{Image_Link="https://images.unsplash.com/photo-1504257365157-1496a50d48f2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80",Description="Anand",Title="Anand wins grandmaster tournamentt",Congrats_Messages=wishes}
